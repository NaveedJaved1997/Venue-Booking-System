    ...
    <div class="row text-white">
        <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col">
                        <div class="card">
                            ...
                            <table class="table table-responsive-lg table table-striped">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT * FROM bookings WHERE item='car' AND vendor_id = '" . $row['id'] . "' ORDER BY id ASC LIMIT $start_from, $limit";
                                    $result = mysqli_query($connection, $sql);
                                    $sr = 1;
                                    while ($num = mysqli_fetch_assoc($result)) {
                                        ...
                                        //From car number
                                        $car = "SELECT * FROM cars WHERE  id = '" . $num['item_id'] . "'";
                                        $carFind = mysqli_query($connection, $car);
                                        $carName = mysqli_fetch_assoc($carFind);
                                        ...
                                        // Check for Payments
                                        // $temp = $carName["id"];
                                        $paymentQuery = "SELECT * FROM payments WHERE item_id= '".$carName["id"]."' AND date = '".$num["date"]."'";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $carName['car_number']; ?></td>
                                            ...
                                            ?></td>
                                            <td>
                                                <a class="text-success" id="approvedBookingId" name="approvedBookingId" type="submit" href="./CarRequests.php?approvedBookingId=<?php echo $num['id']; ?>" onclick="return confirm('Are you sure to Approve ?');">
                                                    <i class="fa fa-check" aria-hidden="true">Approve</i></a>
                                                <a class="text-danger" name="rejectedBookingId" id="rejectedBookingId" type="submit" href="./CarRequests.php?rejectedBookingId=<?php echo $num['id']; ?>" onclick="return confirm('Do you really want to Reject ?');">
            ...
            <div class="col-12 pt-1">
                ...
                $result_db = mysqli_query($connection, "SELECT COUNT(id) from bookings WHERE item='car' AND vendor_id = '" . $logedin_vendor . "'");
        ...
        href='CarRequests.php?page=" . $i . "'>" . $i . "</a></li>";
                }
                echo $pagLink . "</ul>";
                ?>
            </div>
