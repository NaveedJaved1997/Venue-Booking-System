        ...
        <div class="col-lg-12">
            ...
            <table class="table table-responsive-lg table-striped">
              ...
              $start_from = ($page - 1) * $limit;
                    $sql = "SELECT * FROM bookings WHERE item='car' AND client_id = '" . $logedin_user . "'ORDER BY id ASC LIMIT $start_from, $limit";
                    $result = mysqli_query($connection, $sql);
                    $sr=1;
                    while ($num = mysqli_fetch_assoc($result)) {
                        ...
                        // Check for Payments
                        $paymentQuery = "SELECT * FROM payments WHERE item_id= '".$carName["id"]."' AND date = '".$num["date"]."' AND timeslot = '".$num['timeslot']."'";
...
?>
                        <tr>
                            ...
                            <td><?php
                                ...
                                href='./Payments.php?item=car&item_id=<?php echo $carName['id']; ?>&date=<?php echo $num['date']; ?>&timeslot=<?php echo $num['timeslot']; ?>' >
                                ...
                                <?php
                                    ...
                                    echo '  <p class="text-danger">Payment Rejected</p>';
                                }
                           ...
                           <td>
                            ...
                            if($num['booked_on'] >= $tempCurrentDate){
                                ...
                                href="./CarRequests.php?cancelId=<?php echo $num['id']; ?>" onclick="return confirm('Are you sure to Cancel ?');" >
        ...
        $result_db = mysqli_query($connection, "SELECT COUNT(id) from bookings WHERE item='car' AND client_id = '" . $logedin_user . "'");
