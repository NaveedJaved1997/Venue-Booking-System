...
<body>
 ...
 ?>
		  ...
		  <li class="nav-item">
			...
			<li class="nav-item">
            <a href="./Clients.php" class="nav-link text-light font-italic">
                  <i class="fa fa-users mr-3 text-primary fa-fw"></i>
                  Manage Clients
              </a>
        </li>
        <li class="nav-item">
            <a href="./Vendors.php" class="nav-link text-light font-italic">
                  <i class="fa fa-users mr-3 text-primary fa-fw"></i>
                  Manage Vendors
              </a>
        </li>
		<li class="nav-item">
            <a href="./Admins.php" class="nav-link text-light font-italic">
                  <i class="fa fa-user-secret mr-3 text-primary fa-fw"></i>
                  Manage Admins
              </a>
        </li>
        <li class="nav-item">
		...
		<li class="nav-item">
            <a href="./Payments.php" class="nav-link text-light font-italic">
